...
declare namespace Aha {
  ...
  type RecordEventRaw = {
    ...
    createdAt: string;
    epic: Epic;
    eventSubject: RecordEventSubjectUnion;
  ...
  interface ProjectAttributes {
    ...
    readonly createdAt: string;
    readonly defaultCapacityUnits: WorkUnitEnum["values"];
    readonly id: string;
    /**
  ...
  type TaskQuery = Query<Task, never> & QueryFindable<Task>;
  ...
  interface TaskConstructor
    extends ApplicationModelConstructor<Task, never, TaskQuery> {}
  ...
  interface QueryFindable<M extends ApplicationModel> {
    /**
